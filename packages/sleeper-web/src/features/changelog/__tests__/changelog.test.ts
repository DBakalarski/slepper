...
describe('parseChangelog', () => {
  it('sortuje wpisy malejaco po v (najnowszy pierwszy)', () => {
    const raw = [
      { v: 1, date: '2026-06-20', items: ['A'] },
      { v: 3, date: '2026-06-24', items: ['C'] },
      { v: 2, date: '2026-06-22', items: ['B'] },
    ];
  ...
  it('odfiltrowuje wpisy o zlym ksztalcie', () => {
    const raw = [
      { v: 1, date: '2026-06-20', items: ['ok'] },
      { v: 'x', date: '2026-06-21', items: ['bad v'] },
      { v: 2, date: 123, items: ['bad date'] },
      { v: 3, date: '2026-06-22', items: [42] },
      { v: 4, date: '2026-06-23' },
    ];
    const result = parseChangelog(raw);
    expect(result).toEqual([{ v: 1, date: '2026-06-20', items: ['ok'] }]);
  });
});

describe('selectUnseen', () => {
  const entries: ChangelogEntry[] = [
    { v: 3, date: '2026-06-24', items: ['C1', 'C2'] },
    { v: 2, date: '2026-06-22', items: ['B1'] },
    { v: 1, date: '2026-06-20', items: ['A1'] },
  ];
  ...
  it('tnie do 6 punktow i raportuje extraCount', () => {
    const many: ChangelogEntry[] = [
      { v: 1, date: '2026-06-20', items: ['1', '2', '3', '4', '5', '6', '7', '8'] },
    ];
